...
export default function TableOfContents({ headings }: TableOfContentsProps) {
  ...
  return (
    <>
      ...
      */}
      <div className="hidden xl:block xl:fixed top-24 left-[calc((100vw-800px)/2-14rem)] w-52">
        <nav className="border-l-2 border-border pl-3 space-y-1 max-h-[calc(100vh-8rem)] overflow-y-auto">
            <div className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2 pl-0.5">
              目录
            </div>
